<template>
    ...
    <body>
      <section class="min-h-screen flex items-stretch text-white ">
          <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://cdn1.vectorstock.com/i/1000x1000/59/20/retro-poster-for-coffee-shop-vector-1865920.jpg);">
